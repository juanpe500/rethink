...
- **Size the output** — a max-tokens slider defaults to your block's input tokens (html+css) **+20%**,
  and shows that input count, so you can ask for *less* code, the *same*, or *more*.
